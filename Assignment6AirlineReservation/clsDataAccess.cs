...
namespace AirlineReservation
{
    class clsDataAccess
    {
        ...
        /// </summary>
        /// <param name="sSQL">The SQL statement to be executed.</param>
        /// <param name="returnID">Return generated Identity instead of rows affected</param>
        /// <returns>Returns the number of rows affected by the SQL statement, or the generated Identity if ReturnID is true</returns>
        public int executeNonQuery(string sSQL, bool returnID = false)
        {
            try
            {
